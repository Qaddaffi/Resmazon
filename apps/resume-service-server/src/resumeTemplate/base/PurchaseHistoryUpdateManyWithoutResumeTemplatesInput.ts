...
@InputType()
class PurchaseHistoryUpdateManyWithoutResumeTemplatesInput {
...
export { PurchaseHistoryUpdateManyWithoutResumeTemplatesInput as PurchaseHistoryUpdateManyWithoutResumeTemplatesInput };
