...
@InputType()
class PurchaseHistoryCreateNestedManyWithoutUsersInput {
...
export { PurchaseHistoryCreateNestedManyWithoutUsersInput as PurchaseHistoryCreateNestedManyWithoutUsersInput };
