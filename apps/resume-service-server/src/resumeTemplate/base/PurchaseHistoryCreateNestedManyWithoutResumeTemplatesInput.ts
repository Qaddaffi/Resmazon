...
@InputType()
class PurchaseHistoryCreateNestedManyWithoutResumeTemplatesInput {
...
export { PurchaseHistoryCreateNestedManyWithoutResumeTemplatesInput as PurchaseHistoryCreateNestedManyWithoutResumeTemplatesInput };
