...
@InputType()
class ResumeTemplateUpdateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => CommentUpdateManyWithoutResumeTemplatesInput,
  })
  @ValidateNested()
  @Type(() => CommentUpdateManyWithoutResumeTemplatesInput)
  @IsOptional()
  @Field(() => CommentUpdateManyWithoutResumeTemplatesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => LikeUpdateManyWithoutResumeTemplatesInput,
  })
  @ValidateNested()
  @Type(() => LikeUpdateManyWithoutResumeTemplatesInput)
  @IsOptional()
  @Field(() => LikeUpdateManyWithoutResumeTemplatesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => PurchaseHistoryUpdateManyWithoutResumeTemplatesInput,
  })
  @ValidateNested()
  @Type(() => PurchaseHistoryUpdateManyWithoutResumeTemplatesInput)
  @IsOptional()
  @Field(() => PurchaseHistoryUpdateManyWithoutResumeTemplatesInput, {
    nullable: true,
  })
...
export { ResumeTemplateUpdateInput as ResumeTemplateUpdateInput };
